...
public static class CutoverMerger
{
    public static MergeResult Merge(SourceSnapshot egi, SourceSnapshot ledger)
    {
        ...
        foreach (var u in egi.Users) users.Add(ToUser(u, source: "eggincognito"));
        ...
        foreach (var u in ledger.Users)
        {
            ...
            users.Add(ToUser(u, source: "eggledger"));
        }
    ...
    private static User ToUser(SourceUser u, string source) => new()
    {
        UserId = u.UserId,
